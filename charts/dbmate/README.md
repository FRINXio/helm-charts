...
A Helm chart for Kubernetes deployment of the dbmate
...
```console
helm install [RELEASE_NAME] frinx/dbmate
```

## Upgrading Chart

```console
helm upgrade [RELEASE_NAME] frinx/dbmate
```
...
| `image.repository` | Image repository | `amacneil/dbmate` |
